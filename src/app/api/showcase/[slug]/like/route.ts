...
export async function PUT(
  request: Request,
  context: RouteContext<"/api/showcase/[slug]/like">,
): Promise<Response> {
  ...
  try {
    ...
    const result = await toggleReaction("like", slug, ownerId, body.value.on);
    ...
    console.error(`PUT /api/showcase/${slug}/like failed`, error);
